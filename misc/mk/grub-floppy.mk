...
launch-run:
	...
	$(QEMU) $(CONFIG_QEMU) $(QEMU_MISC) $(NETWORK_ARGS) -serial /dev/stdout -pidfile qemu.pid -drive format=raw,media=disk,file=fat:rw:.,if=ide,index=0 -boot a $(QEMU_ENDCOMMAND) &
	if test $$? -eq 0; then $(ECHO) $(ECHO_FLAGS) $(ECHO_GREEN) " OK "; else $(ECHO) $(ECHO_FLAGS) $(ECHO_RED) " KO"; fi
