...
#define POK_CONFIG_PARTITIONS_SIZE  {64000 * 1024, 64000 * 1024};
...
#define POK_CONFIG_SCHEDULING_SLOTS {100000000, 1000000000, 100000000, 1000000000}
#define POK_CONFIG_SCHEDULING_MAJOR_FRAME 53000
