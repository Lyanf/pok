...
#define POK_CONFIG_PARTITIONS_SIZE  {48000 * 1024, 120 * 1024};
...
// #define POK_CONFIG_SCHEDULING_SLOTS {200000000, 4000000000, 100000000, 1000000000}
...
#define POK_CONFIG_PARTITIONS_NTHREADS  {2,1}
